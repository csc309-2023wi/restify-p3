...
const Home = () => {
    ...
    return (<>
        ...
        <div className="container">
            <Sidebar location={address} setAddress={setAddress} 
            from={from} setFrom={setFrom} 
            to={to} setTo={setTo}
            guestCapacity={guestCapacity} setGuestCapacity={setGuestCapacity}
            amenities={amenities} setAmenities={setAmenities}
            click={handleSearch} click1={handleSort} />

            <div className="home-content home-cards">

                {propcards.map((property) => (
